...
public class WorkflowTransitionRulesApiTest {
     ...
     */
    @Test
    public void deleteWorkflowTransitionRuleConfigurationsTest() throws Exception {
        WorkflowsWithTransitionRulesDetails body = null;
        WorkflowTransitionRulesUpdateErrors response = api.deleteWorkflowTransitionRuleConfigurations(body);
     ...
     */
    @Test
    public void getWorkflowTransitionRuleConfigurationsTest() throws Exception {
        List<String> types = null;
        Long startAt = null;
        Integer maxResults = null;
        List<String> keys = null;
        List<String> workflowNames = null;
        List<String> withTags = null;
        Boolean draft = null;
        String expand = null;
     ...
     */
    @Test
    public void updateWorkflowTransitionRuleConfigurationsTest() throws Exception {
