...
import se.phaseshift.jira.rest.client.model.IssueTypeCreateBean;
import se.phaseshift.jira.rest.client.model.IssueTypeDetails;
import se.phaseshift.jira.rest.client.model.IssueTypeUpdateBean;
...
public class IssueTypesApiTest {
     ...
     */
    @Test
    public void createIssueTypeTest() throws Exception {
     ...
     */
    @Test
    public void createIssueTypeAvatarTest() throws Exception {
        Object body = null;
        Integer size = null;
        String id = null;
        Integer x = null;
     ...
     */
    @Test
    public void deleteIssueTypeTest() throws Exception {
        String id = null;
     ...
     */
    @Test
    public void getAlternativeIssueTypesTest() throws Exception {
        String id = null;
     ...
     */
    @Test
    public void getIssueAllTypesTest() throws Exception {
     ...
     */
    @Test
    public void getIssueTypeTest() throws Exception {
        String id = null;
     ...
     */
    @Test
    public void getIssueTypesForProjectTest() throws Exception {
        Long projectId = null;
        Integer level = null;
        List<IssueTypeDetails> response = api.getIssueTypesForProject(projectId, level);
     ...
     */
    @Test
    public void updateIssueTypeTest() throws Exception {
