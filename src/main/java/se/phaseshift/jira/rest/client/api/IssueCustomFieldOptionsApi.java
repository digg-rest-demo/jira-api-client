...
public class IssueCustomFieldOptionsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call replaceCustomFieldOptionCall(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call replaceCustomFieldOptionValidateBeforeCall(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
        ...
        com.squareup.okhttp.Call call = replaceCustomFieldOptionCall(fieldId, optionId, contextId, replaceWith, jql, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void replaceCustomFieldOption(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> replaceCustomFieldOptionWithHttpInfo(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql) throws ApiException {
        com.squareup.okhttp.Call call = replaceCustomFieldOptionValidateBeforeCall(fieldId, optionId, contextId, replaceWith, jql, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call replaceCustomFieldOptionAsync(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = replaceCustomFieldOptionValidateBeforeCall(fieldId, optionId, contextId, replaceWith, jql, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
