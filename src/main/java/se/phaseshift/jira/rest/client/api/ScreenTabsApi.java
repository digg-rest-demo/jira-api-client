...
import se.phaseshift.jira.rest.client.model.ScreenableTab;
...
public class ScreenTabsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBulkScreenTabsCall(List<Long> screenId, List<Long> tabId, Long startAt, Integer maxResult, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (screenId != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "screenId", screenId));
        if (tabId != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "tabId", tabId));
        if (startAt != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getBulkScreenTabsValidateBeforeCall(List<Long> screenId, List<Long> tabId, Long startAt, Integer maxResult, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getBulkScreenTabsCall(screenId, tabId, startAt, maxResult, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void getBulkScreenTabs(List<Long> screenId, List<Long> tabId, Long startAt, Integer maxResult) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> getBulkScreenTabsWithHttpInfo(List<Long> screenId, List<Long> tabId, Long startAt, Integer maxResult) throws ApiException {
        com.squareup.okhttp.Call call = getBulkScreenTabsValidateBeforeCall(screenId, tabId, startAt, maxResult, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBulkScreenTabsAsync(List<Long> screenId, List<Long> tabId, Long startAt, Integer maxResult, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBulkScreenTabsValidateBeforeCall(screenId, tabId, startAt, maxResult, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
