...
public class IssueAttachmentsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Object> getAttachmentContent(String id, Boolean redirect) throws ApiException {
        ApiResponse<List<Object>> resp = getAttachmentContentWithHttpInfo(id, redirect);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> getAttachmentContentWithHttpInfo(String id, Boolean redirect) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAttachmentContentAsync(String id, Boolean redirect, final ApiCallback<List<Object>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Object> getAttachmentThumbnail(String id, Boolean redirect, Boolean fallbackToDefault, Integer width, Integer height) throws ApiException {
        ApiResponse<List<Object>> resp = getAttachmentThumbnailWithHttpInfo(id, redirect, fallbackToDefault, width, height);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> getAttachmentThumbnailWithHttpInfo(String id, Boolean redirect, Boolean fallbackToDefault, Integer width, Integer height) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAttachmentThumbnailAsync(String id, Boolean redirect, Boolean fallbackToDefault, Integer width, Integer height, final ApiCallback<List<Object>> callback) throws ApiException {
