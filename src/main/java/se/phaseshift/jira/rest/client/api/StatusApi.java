...
public class StatusApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getStatusesByIdCall(List<String> id, String expand, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getStatusesByIdValidateBeforeCall(List<String> id, String expand, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getStatusesById(Async)");
        }
        
        com.squareup.okhttp.Call call = getStatusesByIdCall(id, expand, progressListener, progressRequestListener);
        return call;
    ...
    public List<JiraStatus> getStatusesById(List<String> id, String expand) throws ApiException {
        ApiResponse<List<JiraStatus>> resp = getStatusesByIdWithHttpInfo(id, expand);
        return resp.getData();
    }
    ...
    public ApiResponse<List<JiraStatus>> getStatusesByIdWithHttpInfo(List<String> id, String expand) throws ApiException {
        com.squareup.okhttp.Call call = getStatusesByIdValidateBeforeCall(id, expand, null, null);
        Type localVarReturnType = new TypeToken<List<JiraStatus>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStatusesByIdAsync(List<String> id, String expand, final ApiCallback<List<JiraStatus>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatusesByIdValidateBeforeCall(id, expand, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<JiraStatus>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
