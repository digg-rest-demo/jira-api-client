...
public class IssueSearchApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchForIssuesIdsCall(IdSearchRequestBean body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchForIssuesIdsValidateBeforeCall(IdSearchRequestBean body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling searchForIssuesIds(Async)");
        }
        
        com.squareup.okhttp.Call call = searchForIssuesIdsCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public IdSearchResults searchForIssuesIds(IdSearchRequestBean body) throws ApiException {
        ApiResponse<IdSearchResults> resp = searchForIssuesIdsWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<IdSearchResults> searchForIssuesIdsWithHttpInfo(IdSearchRequestBean body) throws ApiException {
        com.squareup.okhttp.Call call = searchForIssuesIdsValidateBeforeCall(body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchForIssuesIdsAsync(IdSearchRequestBean body, final ApiCallback<IdSearchResults> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchForIssuesIdsValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<IdSearchResults>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
