...
import se.phaseshift.jira.rest.client.model.JqlFunctionPrecomputationUpdateRequestBean;
import se.phaseshift.jira.rest.client.model.PageBeanJqlFunctionPrecomputationBean;
...
public class JqlFunctionsAppsApi {
     ...
     */
    public com.squareup.okhttp.Call getPrecomputationsCall(List<String> functionKey, Long startAt, Integer maxResults, String orderBy, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getPrecomputationsValidateBeforeCall(List<String> functionKey, Long startAt, Integer maxResults, String orderBy, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getPrecomputationsCall(functionKey, startAt, maxResults, orderBy, progressListener, progressRequestListener);
        return call;
    ...
    public PageBeanJqlFunctionPrecomputationBean getPrecomputations(List<String> functionKey, Long startAt, Integer maxResults, String orderBy) throws ApiException {
        ApiResponse<PageBeanJqlFunctionPrecomputationBean> resp = getPrecomputationsWithHttpInfo(functionKey, startAt, maxResults, orderBy);
        return resp.getData();
    }
    ...
    public ApiResponse<PageBeanJqlFunctionPrecomputationBean> getPrecomputationsWithHttpInfo(List<String> functionKey, Long startAt, Integer maxResults, String orderBy) throws ApiException {
        com.squareup.okhttp.Call call = getPrecomputationsValidateBeforeCall(functionKey, startAt, maxResults, orderBy, null, null);
     ...
     */
    public com.squareup.okhttp.Call getPrecomputationsAsync(List<String> functionKey, Long startAt, Integer maxResults, String orderBy, final ApiCallback<PageBeanJqlFunctionPrecomputationBean> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPrecomputationsValidateBeforeCall(functionKey, startAt, maxResults, orderBy, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageBeanJqlFunctionPrecomputationBean>(){}.getType();
