...
public class ProjectComponentsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call findComponentsForProjectsCall(List<String> projectIdsOrKeys, Long startAt, Integer maxResults, String orderBy, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "projectIdsOrKeys", projectIdsOrKeys));
        if (startAt != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call findComponentsForProjectsValidateBeforeCall(List<String> projectIdsOrKeys, Long startAt, Integer maxResults, String orderBy, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = findComponentsForProjectsCall(projectIdsOrKeys, startAt, maxResults, orderBy, query, progressListener, progressRequestListener);
        return call;
    ...
    public PageBean2ComponentJsonBean findComponentsForProjects(List<String> projectIdsOrKeys, Long startAt, Integer maxResults, String orderBy, String query) throws ApiException {
        ApiResponse<PageBean2ComponentJsonBean> resp = findComponentsForProjectsWithHttpInfo(projectIdsOrKeys, startAt, maxResults, orderBy, query);
        return resp.getData();
    }
    ...
    public ApiResponse<PageBean2ComponentJsonBean> findComponentsForProjectsWithHttpInfo(List<String> projectIdsOrKeys, Long startAt, Integer maxResults, String orderBy, String query) throws ApiException {
        com.squareup.okhttp.Call call = findComponentsForProjectsValidateBeforeCall(projectIdsOrKeys, startAt, maxResults, orderBy, query, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findComponentsForProjectsAsync(List<String> projectIdsOrKeys, Long startAt, Integer maxResults, String orderBy, String query, final ApiCallback<PageBean2ComponentJsonBean> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = findComponentsForProjectsValidateBeforeCall(projectIdsOrKeys, startAt, maxResults, orderBy, query, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageBean2ComponentJsonBean>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getProjectComponentsCall(String projectIdOrKey, String componentSource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("componentSource", componentSource));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getProjectComponentsValidateBeforeCall(String projectIdOrKey, String componentSource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getProjectComponentsCall(projectIdOrKey, componentSource, progressListener, progressRequestListener);
        return call;
    ...
    public List<ProjectComponent> getProjectComponents(String projectIdOrKey, String componentSource) throws ApiException {
        ApiResponse<List<ProjectComponent>> resp = getProjectComponentsWithHttpInfo(projectIdOrKey, componentSource);
        return resp.getData();
    }
    ...
    public ApiResponse<List<ProjectComponent>> getProjectComponentsWithHttpInfo(String projectIdOrKey, String componentSource) throws ApiException {
        com.squareup.okhttp.Call call = getProjectComponentsValidateBeforeCall(projectIdOrKey, componentSource, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProjectComponentsAsync(String projectIdOrKey, String componentSource, final ApiCallback<List<ProjectComponent>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getProjectComponentsValidateBeforeCall(projectIdOrKey, componentSource, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ProjectComponent>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getProjectComponentsPaginatedCall(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String componentSource, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getProjectComponentsPaginatedValidateBeforeCall(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String componentSource, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'projectIdOrKey' is set
        if (projectIdOrKey == null) {
            throw new ApiException("Missing the required parameter 'projectIdOrKey' when calling getProjectComponentsPaginated(Async)");
        }
        
        com.squareup.okhttp.Call call = getProjectComponentsPaginatedCall(projectIdOrKey, startAt, maxResults, orderBy, componentSource, query, progressListener, progressRequestListener);
        return call;
    ...
    public PageBeanComponentWithIssueCount getProjectComponentsPaginated(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String componentSource, String query) throws ApiException {
        ApiResponse<PageBeanComponentWithIssueCount> resp = getProjectComponentsPaginatedWithHttpInfo(projectIdOrKey, startAt, maxResults, orderBy, componentSource, query);
        return resp.getData();
    }
    ...
    public ApiResponse<PageBeanComponentWithIssueCount> getProjectComponentsPaginatedWithHttpInfo(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String componentSource, String query) throws ApiException {
        com.squareup.okhttp.Call call = getProjectComponentsPaginatedValidateBeforeCall(projectIdOrKey, startAt, maxResults, orderBy, componentSource, query, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProjectComponentsPaginatedAsync(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String componentSource, String query, final ApiCallback<PageBeanComponentWithIssueCount> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getProjectComponentsPaginatedValidateBeforeCall(projectIdOrKey, startAt, maxResults, orderBy, componentSource, query, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageBeanComponentWithIssueCount>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
